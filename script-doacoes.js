alert("Essa é uma página ilustrativa, portanto não coloque informações de cartões reais! For Your Voice agradece a compreensão! <3");
...
input_credit_card = function(input)
{
    ...
    //card number on the little card over thereeeeeeee
